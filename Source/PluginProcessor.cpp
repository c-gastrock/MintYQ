...
//==============================================================================
const juce::String ChaseGP02MintYQAudioProcessor::getName() const
{
...
const juce::String ChaseGP02MintYQAudioProcessor::getProgramName (int index)
{
    return {};
}

void ChaseGP02MintYQAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void ChaseGP02MintYQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* ChaseGP02MintYQAudioProcessor::createEditor()
{
    return new ChaseGP02MintYQAudioProcessorEditor (*this);
}

//==============================================================================
void ChaseGP02MintYQAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
